...
README.md
CONTEXT.md
.gitignore                       # excludes: settings.yaml, oktagov2snipe binary, .cache/, .DS_Store
```
...
| Asset | Platform |
|-------|----------|
| `oktagov2snipe-darwin-arm64` | macOS (Apple Silicon) |
| `oktagov2snipe-linux-amd64` | Linux x86-64 |
| `oktagov2snipe-linux-arm64` | Linux ARM64 |
| `oktagov2snipe-windows-amd64.exe` | Windows x86-64 |
